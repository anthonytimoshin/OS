...
./knn {number of threads}
```
Bash script [run.sh](https://github.com/anthonytimoshin/OS/blob/aa21e362e4d0e1db99032de9ce10ace0887026b6/LR4/run.sh) to run [knn_simple.c](https://github.com/anthonytimoshin/OS/blob/323faf0ddba006ef7757d049b948a38d923f4f1a/LR4/knn_simple.c) with 1, 2, 4, 8, 16, 32, 64 threads 100 times to collect statistics.  
